...
export default function SignUpComponent() {
  ...
  return (
    <div className="w-full max-w-md border border-[color:hsl(var(--border))] bg-[color:hsl(var(--surface))] rounded-lg shadow-xl p-6">
      <div className="mb-6">
        <h2 className="font-mono font-bold tracking-tight text-lg text-[color:hsl(var(--text-primary))]">Create an Account</h2>
      ...
      <div className="mt-6 text-center font-mono text-[10px] text-[color:hsl(var(--text-muted))]">
        Already have an account? <Link href="/sign-in" className="text-[color:hsl(var(--primary))] hover:underline">Sign in</Link>
      </div>
    </div>
  );
}
